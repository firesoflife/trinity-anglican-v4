  ...
  return (
    <header className="navbar bg-secondary px-16">
      <div className="flex-1">
        <Link href={'/'} className="btn btn-ghost normal-case text-xl font-mainContent ">{home.pageTitle}</Link>
      </div>
      <div className="flex-none">
        <ul className={'menu menu-horizontal px-1 text-accent font-mainContent'}>
          <li tabIndex={0}>
            <Link href={'/about'} className='hover:bg-sky-700 hover:bg-opacity-70 hover:text-secondary'>
              About Us
